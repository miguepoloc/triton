jQuery(document).ready(function ($) {
    ...
    $.ajax({
        ...
        success: function (xml) {
            ...
            window.meteogram = new Meteogram(xml_data, 'containerp1', true, true, false, false);
            window.meteogram = new Meteogram(xml_data, 'containerp2', false, false, true, true);
            var fecha = new Date(xml_data[0].fecha_hora);
            //console.log(fecha);
        },
