...
var variables = [{
    ...
    p: {
      ...
      // Activar la transparencia de la capa
      TRANSPARENT: true,
      // El estilo en el que se desea la capa
      STYLES: 'boxfill/redblue',
      // Numero de bandas de color
      NUMCOLORBANDS: 50,
      // Tipo de paleta
      palete: "redblue"
    },
...
function llenarlista(capa) {
  ...
  $.get(homeUrl + "catalog/" + capa.variable + "/latest.xml", function (data) {
    ...
    console.log(homeUrl + 'wms/' + capa.l[0] + '?');
...
dojo.ready(function () {
  dojo.declare("Mapa", esri.layers.DynamicMapServiceLayer, {
    ...
    getImageUrl: function (extent, width, height, callback) {
      ...
      callback("http://192.168.3.173:8080/thredds/wms/SLA-H/nrt_global_allsat_phy_l4_20191016.nc?" + dojo.objectToQuery(params));
    }
  });
});
